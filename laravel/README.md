...
```
    ...
    SAML2_SP_ENTITYID="https://127.0.0.1.slovensko.sk.login2"
    SAML2_LOGIN_URL="https://127.0.0.1:3001/authenticated"
    SAML2_LOGOUT_URL="https://127.0.0.1:3001/"
    SAML2_ERROR_URL="https://127.0.0.1:3001/error"
```
