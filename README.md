...
1. **Prístup do testovacieho prostredia slovensko.sk**  
  ...
  Prístup na toto prostredie získate až po registrácii do partner framework portálu a žiadosti zaslanej do NASES<sup>1</sup>
...
<sup>1</sup> Informácie ohľadom žiadania o vytvorenie infraštruktúrneho prepojenia sú uvedené v dokumente s názvom Všeobecný popis integrácie OVM, PO v sekcii Žiadosť o vytvorenie infraštruktúrneho prepojenia (FIX). Dokument sa nachádza na portáli v časti Integrácia na ÚPVS, Ako začať.

<sup>2</sup> Informácie ohľadom žiadania o testovacie identity sú uvedené v dokumente s názvom Všeobecný popis integrácie OVM, PO v sekcii Žiadosť o zriadenie testovacích identít. Dokument sa nachádza na portáli v časti Integrácia na ÚPVS, Ako začať.

<sup>3</sup> Metadáta IdP / SP musia byť zaregistrované v prostredí ÚPVS.
